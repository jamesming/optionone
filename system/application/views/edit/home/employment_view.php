...
<div   class='container'       >
		...
		<div id=''  class='last span-8  '      style='padding-top:30px; vertical-align:top'      >
			...
			<div  id='employment_pdf_div' href="#fancy_zoom_modal_box_for_text_editor" class='fancy_zoom_modal_box_for_text_editor_link cursor_pointer' style='padding:5px 5px 5px 15px;background:url(<?php echo base_url()    ?>images/bluebox_center.jpg) repeat-y '>
