...
if( $_SERVER['HTTP_HOST'] == 'jamesming.whsites.net' ){
	...
	$config['base_url']	= "http://localhost/optionone";
...
}elseif( $_SERVER['HTTP_HOST'] == 'ihcoption.com' ){
	$config['base_url']	= "http://ihcoption.com";
}elseif( $_SERVER['HTTP_HOST'] == 'optiononecareathome.com' ){
	$config['base_url']	= "http://optiononecareathome.com";
};
...
$config['facebook_apid'] = '123501404356532';  
$config['facebook_api_key'] = 'e083b54a9d1bc8c2addfc47731b3c805';  
$config['facebook_secret_key'] = '3f1180dfecbe909b3a8cc7ef60f120f0'; 
